...
<div class="pile">
    <x-page-header
        :fil="['Poste', 'Fin de consultation']"
        titre="Fin de consultation"
        sous-titre="Conclure un passage : conclusion, ordonnance ou rendez-vous." />

    @livewire('service.consultation-actions', ['serviceId' => $serviceId], key('staff-consultation-'.$serviceId))
</div>
